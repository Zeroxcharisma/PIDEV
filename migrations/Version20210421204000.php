 ...
 */
final class Version20210421204000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD parent_id INT DEFAULT NULL, ADD created_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaire DROP parent_id, DROP created_at');
    }
}
