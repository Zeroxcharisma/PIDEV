 ...
 /////////
      ...
      //  mesListes.setUIID("SelectBar");
       ...
       // liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("New User", barGroup);
      ...
      //  bindButtonSelection(liste, arrow);
        ...
        //list of posts
         ...
         for(Utilisateur p : list){
           ...
           addButton(urlim,p.getEmail(), p.getNom() + "\n", p.getPrenom() ,p,res);
    ...
    private void addButton(Image img,String mail, String nom, String prenom, Utilisateur p, Resources res ) {
       ...
       image.setUIID("Label");
        ...
        Container cnt = BorderLayout.west(image);
            Label d = new Label(mail+" ","NewsTopLine"); 
          Label c = new Label(nom+"\n","NewsTopLine"); 
            Label date = new Label(prenom+"\n","NewsTopLine"); 
            ...
            del.addPointerPressedListener(l ->{
                ...
                {
           //         if(ServiceUtilisateur.getInstance().deletePost(p.getId_utilisateur()))
                        new ListTasksForm(res).show();
                refreshTheme();
