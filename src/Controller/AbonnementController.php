...
class AbonnementController extends AbstractController
{
    ...
    /**
     * @Route("/new/Front", name="abonnement_newFront", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}/Front", name="abonnement_showFront", methods={"GET"})
     */
    public function showFront(Abonnement $abonnement): Response
    {
