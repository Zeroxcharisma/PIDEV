...
// sp.setText(ServiceProduct.getInstance().getAllProductsAction().toString());
  //add(sp);
  /***********************************************************************************/
           ArrayList<Testfitness> liste=TestfitnessService.getInstance().getFiltredProductsAction(ListTest.minA, ListTest.maxA);
  /*************************************Filtre Bar****************************************/
