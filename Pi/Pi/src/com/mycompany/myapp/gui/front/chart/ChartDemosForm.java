...
import com.mycompany.myapp.Home.Home;
...
public class ChartDemosForm extends Form{
    ...
    ListOption[] options = new ListOption[]{
        ...
        new ListOption(BudgetPieChart.class, "pourcentage des durées Pie Chart"),
    ...
    public ChartDemosForm(){
        ...
        for ( int i=0; i<options.length; i++){
            formMenu.addItem(options[i]);
                ...
                FontImage.MATERIAL_BACKUP, ev->{new Home(res).show();});
