 ...
 * @author yossr
 */
public class HomeProduitSearched extends Form{
    Form currentB;
   static Produit b=new Produit();

   ArrayList<Produit> listProduit=new ArrayList<>();
    public HomeProduitSearched(Form previous) {
...
// sp.setText(ServiceProduct.getInstance().getAllProductsAction().toString());
  ...
  /***********************************************************************************/
         ...
         ArrayList<Produit> liste=ProduitService.getInstance().getSearcheProduitAction(ListProd.rechercher);
/*****************************************Rechercher*****************************************************************/
